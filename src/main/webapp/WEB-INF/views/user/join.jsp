...
<script type="text/javascript">
	...
	<div class="center-content">
		...
		<!-- MultiPart 객체로 전송 -->
		<form class="join-form" id="join-form" method="post" action="${pageContext.request.contextPath}/user/join" enctype="multipart/form-data">
			...
			<!-- Ajax로 구현 --> 
			<input id="btn-id" type="button" value="아이디 중복">
			...
			<label class="block-label" for="title">블로그 타이틀</label>
			<input id="blog-title" name="title" type="text" />
			
			<label class="block-label" for="logo">블로그 로고</label>
